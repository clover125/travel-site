class Modal {
    ...
    injectHTML() {
        ...
        <div class="modal__inner">
          <h2 class="section-tittle section-tittle--blue section-tittle--less-margin"><img src="assets/images/icons/mail.svg"
              class="section-tittle__icon"> Get in <strong>Touch</strong></h2>
